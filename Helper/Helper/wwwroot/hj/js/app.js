...
$(document).ready(function () {
    ...
    var valid2 = true;
    $('#plus-profile2').on('click', function () {
        if (valid2) {
            valid2 = false;
            $("#Record2").toggleClass("toggle-Record");
            $("#plus-profile2").addClass("fa-minus-circle");
            $("#plus-profile2").removeClass("fa-plus-circle");
        } else {
            valid2 = true;
            $("#Record2").toggleClass("toggle-Record");
            $("#plus-profile2").removeClass("fa-minus-circle");
            $("#plus-profile2").addClass("fa-plus-circle");
        }
    });
    ...
    var valid3 = true;
    $('#plus-profile3').on('click', function () {
        if (valid2) {
            valid2 = false;
            $("#Record3").toggleClass("toggle-Record");
            $("#plus-profile3").addClass("fa-minus-circle");
            $("#plus-profile3").removeClass("fa-plus-circle");
        } else {
            valid2 = true;
            $("#Record3").toggleClass("toggle-Record");
            $("#plus-profile3").removeClass("fa-minus-circle");
            $("#plus-profile3").addClass("fa-plus-circle");
        }
    });
});
