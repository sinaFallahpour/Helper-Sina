...
var HoemContactUsView = function () {
    var _a = useState(undefined), ContactUs = _a[0], setContactUs = _a[1];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, agent.ContactUs.contactUs()];
                        case 2:
                            res = _a.sent();
                            if (res.status == 1) {
    ...
    return (React.createElement(Fragment, null,
        React.createElement("div", { className: "container mx-auto p-0 m-0 mt-5" },
            ...
            React.createElement("div", { className: "row  p-2 m-0  mt-3" }, ReactHtmlParser(ContactUs || "")))));
};
ReactDOM.render(React.createElement(HoemContactUsView, null), document.getElementById('root'));
//# sourceMappingURL=HomeContact.js.map