    ...
    public partial class appUSer : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 7, 28, 9, 52, 15, 122, DateTimeKind.Local).AddTicks(5712), "AboutUs", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "" });

            migrationBuilder.InsertData(
                table: "TBL_Settings",
                columns: new[] { "Id", "CreatedAt", "Key", "UpdatedAt", "Value" },
                values: new object[] { 2, new DateTime(2020, 7, 28, 9, 52, 15, 126, DateTimeKind.Local).AddTicks(860), "Contactus", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "" });
