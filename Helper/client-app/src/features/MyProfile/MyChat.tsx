...
const MyChat: React.FC = () => {
    return (
        <>
            <div className="row w-100 mx-auto hj-hiden">
                <div id="frame">
                    <div id="sidepanel">
                        <div id="profile">
                            <div className="wrap">
                                ...
                                <p>Mike Ross</p>
                                <i className="fas fa-chevron-down expand-button" aria-hidden="true"></i>
                                ...
                                <div id="expanded">
                                    <label htmlFor="twitter"><i className="fab fa-facebook fa-fw" aria-hidden="true"></i></label>
                                    <input name="twitter" type="text" value="mikeross" />
                                    <label htmlFor="twitter"><i className="fab fa-twitter fa-fw" aria-hidden="true"></i></label>
                                    <input name="twitter" type="text" value="ross81" />
                                    <label htmlFor="twitter"><i className="fab fa-instagram fa-fw" aria-hidden="true"></i></label>
                                    <input name="twitter" type="text" value="mike.ross" />
                                </div>
                            </div>
                        </div>
                        <div id="search">
                            <label htmlFor=""><i className="fas fa-search" aria-hidden="true"></i></label>
                    ...
                    <div className="content">
                        <div className="contact-profile">
                            <img src="http://emilcarlsson.se/assets/harveyspecter.png" alt="" />
                            <p>Harvey Specter</p>
                            <div className="social-media pr-3">
